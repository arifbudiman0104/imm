    ...
    <div class="w-full sm:py-12">
        <x-section>
            <h1 class="text-3xl font-semibold text-center text-gray-800 capitalize lg:text-4xl dark:text-white">Our
                <span class="text-blue-500">Timeline</span>
            </h1>
            ...
            <ol class="relative mt-8 border-l border-gray-200 xl:mt-16 left-4 sm:left-0 dark:border-gray-700">
                <li class="mb-10 ml-6">
                    <span
            ...
            <div class="container py-10 mx-auto">
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                    <div
                        ...
                        <p class="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Lorem
                            ipsum dolor sit amet consectetur adipisicing elit. Illum nesciunt officia aliquam neque
                            optio? Cumque facere numquam est.</p>
